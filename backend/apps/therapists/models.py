...
class TherapistProfile(models.Model):
    ...
    # Status of credential update request (independent of profile status)
    CREDENTIAL_UPDATE_CHOICES = [
        ("none", "No Update"),
        ("pending", "Pending"),
        ("approved", "Approved"),
        ("rejected", "Rejected"),
    ]
    credential_update_status = models.CharField(
        max_length=20,
        choices=CREDENTIAL_UPDATE_CHOICES,
        default="none",
        db_index=True,
